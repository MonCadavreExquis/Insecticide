...
if(rendu === 1){
 ...
 p.text('Son corps est petit et rond. ', 20, 226);
 p.text('Le mouvement est furtif , les pattes sont rapides. ', 20, 254);
 p.text('L’insecte s’arrête, un instant. Me regarde.', 20, 310);
 ...
 p.text('Je suis aspirée. Dans le sommeil, dans le plafond, je ne sais pas.', 20, 394);
...
if (rendu === 2){
 ...
 let  r = 255;
  ...
  p.text('Je n’ai pas peur de la folie, mais il faut me montrer comment ça marche.', 20, 30);
 ...
 p.text('Puis il s’installe à mon côté. ', 20, 198);
 ...
 p.text('« Quand les gens rêvent de nature, tu sais, ils ne rêvent jamais de nous.', 20, 450);
 p.text('Ils dizzzent notre nom avec dédain. » ', 20, 478);
  p.text('Les autres insectes s’approchent de nous. Des petits, demandant le réconfort d’un câlin.', 20, 534);
 ...
 p.text('Je me sens chez nous, au creux de cet amas ondoyant.', 20, 758);
...
if (rendu === 3){
 ...
 p.text('« Noooon. Toucher, c’est la pire chose à faire. ', 20, 590);
  p.text('Les insectes, on a peur, quand on nous touche.', 20, 618);
 p.text('Alors, on se cache sous la peau, ssssans bouger. On fait sssssemblant d’être une partie de vous. »', 20, 646);
...
if (rendu === 4){
 ...
 p.text('Ici et là, des pattes graffignent ma chair infestée.', 20, 198);
